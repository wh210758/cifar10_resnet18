...
<img width="1217" height="404" alt="{704E7638-7542-4803-AE70-0DE7740DB098}" src="https://github.com/user-attachments/assets/b936066f-38d0-466c-9587-97d0df399eba" />
...
```bash
# 构建镜像
docker build -t cifar10-resnet18:latest .
